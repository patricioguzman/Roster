...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // ⚡ Bolt Optimization: Group independent database queries with Promise.all to reduce latency
        const [settingsRows, rawStores, members, rawShifts, mgrStoresResult] = await Promise.all([
        ...
        const mgrStores = Array.isArray(mgrStoresResult) ? mgrStoresResult : [];
