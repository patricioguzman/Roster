...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // ⚡ Bolt: Parallelize independent database queries to reduce overall latency,
        // especially when using MySQL connection pooling.
        const [settingsRows, rawStores, rawMembers, mgrStores, rawShifts, userManagedStores] = await Promise.all([
