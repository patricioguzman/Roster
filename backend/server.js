...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // ⚡ Bolt Performance Optimization: Execute database queries in parallel using Promise.all
        // and push store filtering into the database layer to reduce memory and data transfer.
