...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // Fetch independent data concurrently via Promise.all instead of sequential awaits
        // This eliminates cumulative round-trip latency when connecting to remote MySQL DBs
        const [settingsRows, storesRows, membersRows, mgrStoresRows, shiftsRows] = await Promise.all([
