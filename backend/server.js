...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // ⚡ Bolt: Parallelized Database Queries
        // Grouping independent SELECT queries with Promise.all reduces network latency
        // and improves backend performance by executing queries concurrently.
        ...
        const [settingsRows, rawStores, members, mgrStoresRaw, rawShifts] = await Promise.all([
