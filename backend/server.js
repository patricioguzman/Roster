...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // Push store filtering to SQL to reduce memory overhead and latency
        ...
        // ⚡ Bolt: Parallelize DB fetches and apply filter in query to reduce latency and memory overhead.
