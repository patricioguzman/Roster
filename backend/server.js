...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // ⚡ Bolt Optimization: Parallelize DB queries and push filters to SQL to reduce memory overhead
        ...
        const [
            ...
            db.query('SELECT member_id, store_id FROM manager_stores').catch(() => []), // gracefully handle missing table
            db.query(shiftsQuery, shiftsParams)
        ]);

        let mgrStores = mgrStoresResult;
