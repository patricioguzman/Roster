...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // Bolt: Optimize data loading by parallelizing independent read queries
        const [settingsRows, storesDb, membersDb, mgrStoresDb, shiftsDb] = await Promise.all([
