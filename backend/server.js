...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // Using Promise.all to fetch independent data sources concurrently
        // instead of awaiting them sequentially, significantly reducing latency, especially with MySQL pooling.
