...
app.get('/api/data', async (req, res) => {
    try {
        ...
        // Bolt: Performance Optimization - Parallelized Data Fetching
        // Batched independent sequential queries into a concurrent Promise.all array
        // to significantly reduce cumulative database roundtrip latency.
        const [settingsRows, rawStores, members, mgrStoresResult, rawShifts] = await Promise.all([
        ...
        let mgrStores = Array.isArray(mgrStoresResult) ? mgrStoresResult : [];
