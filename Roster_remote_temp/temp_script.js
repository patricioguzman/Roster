            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (dom.sidebarExportBtn) {
                    dom.sidebarExportBtn.addEventListener('click', () => {
                        closeSidebar();
                        // Instead of showing the export modal, directly generate CSV as requested by SaaS restructure
                        generateRosterCSV();
                    });
                }
                ...
                if (startTourBtn) {
                    startTourBtn.addEventListener('click', () => {
                        ...
                        // Added steps only if in Admin mode
                        if (isAdmin) {
                            steps.push({
                                element: document.querySelector('#openSidebarBtn'),
                                title: 'Admin & Extra Tools',
                                intro: 'As an administrator, you can manage Rules, Stores, Members, and Exports from this menu.',
                                position: 'right'
                            });
                            steps.push({
